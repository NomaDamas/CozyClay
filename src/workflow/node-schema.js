...
export const DEFAULT_NODE_SCHEMAS = {
	...
	categories: {
		...
		video: { models: {
			...
			"video-generation": { name: "Video Generation", input_schema: { schemas: { input_data: { properties: { provider: field("string", "Provider", { enum: ["comfy", "fal"], default: "comfy" }), prompt: field("string", "Motion prompt"), duration_seconds: field("number", "Duration", { default: 5, minimum: 1, maximum: 15, step: 1 }), aspect: field("string", "Aspect ratio", { enum: ["16:9", "9:16", "1:1", "21:9", "12:7"], default: "16:9" }), extract_mocap: field("boolean", "Extract GVHMR motion", { default: false }) } } } } },
		} },
		audio: { models: {
