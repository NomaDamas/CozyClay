...
export function evaluateQuality(metrics, limits = DEFAULT_LIMITS) {
	const checks = [
		...
		{
			name: "jitter",
			value: metrics.jitterMmPerFrame2,
			limit: limits.maxJitterMmPerFrame2,
			pass: metrics.jitterMmPerFrame2 <= limits.maxJitterMmPerFrame2,
			unit: "mm/frame²",
		},
		{
...
function usage() {
	console.error("usage: node tools/ardy/mocap-quality-gate.mjs <take.npz> [--foot-slide cm/s] [--jitter mm/frame²] [--below-floor fraction] [--depth cm]");
}
